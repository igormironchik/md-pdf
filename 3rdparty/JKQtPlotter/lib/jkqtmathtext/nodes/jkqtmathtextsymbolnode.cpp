...
void JKQTMathTextSymbolNode::fillSymbolTables()
{
    ...
    symbols["Beth"]=SymbolUnicode(QChar(0x2136)).addHtml("&beth;");
	symbols["Bet"]=SymbolUnicode(QChar(0x2136)).addHtml("&beth;");
	symbols["beth"]=SymbolUnicode(QChar(0x2136)).addHtml("&beth;");
	symbols["bet"]=SymbolUnicode(QChar(0x2136)).addHtml("&beth;");
    ...
    symbols["S"]=SimpleTextSymbol(QChar(0xA7)).addHtml("&sect;");
	symbols["§"]=SimpleTextSymbol(QChar(0xA7)).addHtml("&sect;");
    symbols["accurrent"]=SymbolUnicode(QChar(0x23E6));
    symbols["alef"]=SymbolUnicode(QChar(0x2135)).addHtml("&aleph;").addWinSymbol(QChar(0xC0));
	symbols["aleph"]=SymbolUnicode(QChar(0x2135)).addHtml("&aleph;").addWinSymbol(QChar(0xC0));
	symbols["Aleph"]=symbols["Alef"]=SymbolUnicode(QChar(0x2135)).addHtml("&aleph;").addWinSymbol(QChar(0xC0));
	symbols["Alef"]=SymbolUnicode(QChar(0x2135)).addHtml("&aleph;").addWinSymbol(QChar(0xC0));
    ...
    symbols["celsius"]=SymbolUnicode(QChar(0x2103)).addUprightStd("°C").addUprightHtml("&deg;C");
	symbols["degC"]=SymbolUnicode(QChar(0x2103)).addUprightStd("°C").addUprightHtml("&deg;C");
    ...
    symbols["copyright"]=SimpleTextSymbol(QChar(0xA5), "&copy;");
	symbols["textcopyright"]=SimpleTextSymbol(QChar(0xA5), "&copy;");
    symbols["dalet"]=SymbolUnicode(QChar(0x2138)).addHtml("&daleth;");
	symbols["Dalet"]=SymbolUnicode(QChar(0x2138)).addHtml("&daleth;");
	symbols["daleth"]=SymbolUnicode(QChar(0x2138)).addHtml("&daleth;");
	symbols["Daleth"]=SymbolUnicode(QChar(0x2138)).addHtml("&daleth;");
    ...
    symbols["dollar"]=SimpleTextSymbol(QChar(0x24), "&dollar;");
	symbols["$"]=SimpleTextSymbol(QChar(0x24), "&dollar;");
    symbols["dprime"]=SymbolUnicode(QChar(0x2033)).addHtml("&Prime;").addStd("''");
    symbols["ellipsis"]=SymbolUnicode(QChar(0x2026)).addHtml("&mldr;").addWinSymbol(QChar(0xBC)).addStd("...");
	symbols["dots"]=SymbolUnicode(QChar(0x2026)).addHtml("&mldr;").addWinSymbol(QChar(0xBC)).addStd("...");
	symbols["ldots"]=SymbolUnicode(QChar(0x2026)).addHtml("&mldr;").addWinSymbol(QChar(0xBC)).addStd("...");
    symbols["euro"]=SimpleTextSymbol(QChar(0x20AC), "&euro;");
	symbols["EUR"]=SimpleTextSymbol(QChar(0x20AC), "&euro;");
    symbols["fahrenheit"]=SymbolUnicode(QChar(0x2109));
	symbols["degF"]=SymbolUnicode(QChar(0x2109));
    ...
    symbols["gimel"]=SymbolUnicode(QChar(0x2137)).addHtml("&gimel;");
	symbols["Gimel"]=SymbolUnicode(QChar(0x2137)).addHtml("&gimel;");
    ...
    symbols["ldots"]=SimpleTextSymbol("...");
	symbols["dots"]=SimpleTextSymbol("...");
    ...
    symbols["perthousand"]=SymbolUnicode(QChar(0x2030)).addHtml("&permil;");
	symbols["permil"]=SymbolUnicode(QChar(0x2030)).addHtml("&permil;");
    ...
    symbols["registered"]=SimpleTextSymbol(QChar(0xAA), "&reg;");
	symbols["textregistered"]=SimpleTextSymbol(QChar(0xAA), "&reg;");
	symbols["circledR"]=SimpleTextSymbol(QChar(0xAA), "&reg;");
    ...
    symbols["textdegree"] = SimpleTextSymbol(QChar(0xB0), "&deg;");
	symbols["degree"] = SimpleTextSymbol(QChar(0xB0), "&deg;");
    symbols["textgreater"]=SimpleTextSymbol(">", "&gt;");
    symbols["textless"]=SimpleTextSymbol("<", "&lt;");
    symbols["tlcorner"]=SymbolUnicode(QChar(0x231C));
	symbols["ulcorner"]=SymbolUnicode(QChar(0x231C));
     ...
     **************************************************************************************/
    symbols["*"]=MathOperatorSymbolUnicode(QChar(0x2217)).addMathOperatorStd("*").addMathOperatorHtml("*");
	symbols["ast"]=MathOperatorSymbolUnicode(QChar(0x2217)).addMathOperatorStd("*").addMathOperatorHtml("*");
	symbols["asterisk"]=MathOperatorSymbolUnicode(QChar(0x2217)).addMathOperatorStd("*").addMathOperatorHtml("*");
    ...
    symbols["bot"]=MathOperatorSymbolUnicode(QChar(0x22A5)).addMathOperatorHtml("&UpTee;");
	symbols["perp"]=MathOperatorSymbolUnicode(QChar(0x22A5)).addMathOperatorHtml("&UpTee;");
    symbols["cap"]=MathOperatorSymbolUnicode(QChar(0x2229)).addMathOperatorHtml("&cap;").addMathOperatorWinSymbol(QChar(0xC7));
	symbols["land"]=MathOperatorSymbolUnicode(QChar(0x2229)).addMathOperatorHtml("&cap;").addMathOperatorWinSymbol(QChar(0xC7));
    ...
    symbols["cup"]=MathOperatorSymbolUnicode(QChar(0x222A)).addMathOperatorHtml("&cup;").addMathOperatorWinSymbol(QChar(0xC8));
	symbols["lor"]=MathOperatorSymbolUnicode(QChar(0x222A)).addMathOperatorHtml("&cup;").addMathOperatorWinSymbol(QChar(0xC8));
    ...
    symbols["emptyset"]=MathOperatorSymbolUnicode(QChar(0x2205)).addMathOperatorHtml("&varnothing;").addMathOperatorWinSymbol(QChar(0xC6)).addStd("0", BoldOff|ItalicOff|DrawSlash);
	symbols["varnothing"]=MathOperatorSymbolUnicode(QChar(0x2205)).addMathOperatorHtml("&varnothing;").addMathOperatorWinSymbol(QChar(0xC6)).addStd("0", BoldOff|ItalicOff|DrawSlash);
    ...
    symbols["geq"]=MathOperatorSymbolUnicode(QChar(0x2265)).addMathOperatorHtml("&GreaterEqual;").addMathOperatorWinSymbol(QChar(0xB3));
	symbols["ge"]=MathOperatorSymbolUnicode(QChar(0x2265)).addMathOperatorHtml("&GreaterEqual;").addMathOperatorWinSymbol(QChar(0xB3));
    ...
    symbols["leq"]=MathOperatorSymbolUnicode(QChar(0x2264)).addMathOperatorHtml("&leq;").addMathOperatorWinSymbol(QChar(0xA3));
	symbols["le"]=MathOperatorSymbolUnicode(QChar(0x2264)).addMathOperatorHtml("&leq;").addMathOperatorWinSymbol(QChar(0xA3));
    ...
    symbols["neg"]=MathOperatorSymbolUnicode(QChar(0x00AC)).addMathOperatorHtml("&not;").addMathOperatorWinSymbol(QChar(0xD8));
	symbols["lnot"]=MathOperatorSymbolUnicode(QChar(0x00AC)).addMathOperatorHtml("&not;").addMathOperatorWinSymbol(QChar(0xD8));
    ...
    symbols["~"]=MathOperatorSymbolUnicode(QChar(0x223C)).addMathOperatorHtml("&tilde;").addMathOperatorStd("~");
	symbols["sim"]=MathOperatorSymbolUnicode(QChar(0x223C)).addMathOperatorHtml("&tilde;").addMathOperatorStd("~");
	symbols["tilde"]=MathOperatorSymbolUnicode(QChar(0x223C)).addMathOperatorHtml("&tilde;").addMathOperatorStd("~");
